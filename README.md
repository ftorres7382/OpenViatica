...
For the developers contributing to the project, there are other packages that need to be installed
1. Follow all steps in [Setup & Usage Steps](#setup-and-usage-steps) 
...
3. Drawio VSCode (Or Codium) Extension is recommended

# Contributions (Needs revision)
- For anyone who wants to make contributions to this project, go [here](Project_Source/Documentation/README.md)
- For sending any proposals/ideas or arquitecture changes send them to ftorres7382@gmail.com (at some point I would like to do the whole mailing list thing and keep track of community discussions that way)
...
# Test
![test_diagram](Project_Source/test.drawio)
