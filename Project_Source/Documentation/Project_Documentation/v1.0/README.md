...
8. **Workspace Folder Structure:** Must contain a folder structure helping guide the user on how they should structure their own work.
    ...
    6. (optional) Services: For defining anything like docker or other services that could need to be tarted up by the user.
    7. The workspace folder structure MUST be configurable on or after initialization
