...
The purpose of this folder is to contain all the relevant documentation about the project scope and its intended supported features in the future
...
1. user-space
    ...
    2. This term is used a lot in the linux community and this project aims to keep the same promise.
    3. This would apply to the following:
        1. CLI commands and flags intended for the user(s)
        2. APIs intended for the user(s)
        3. Config files intended for the user(s) to configure any of the undelying tools
